...
def main(batch_size_for_worker=256, technical_batch_size=512,
...
if __name__ == "__main__":
    ...
    iter_id = 0
    do_iters = [0,1,2,3]
    for conf in zip(n_iters, Ks, no_comprs, batch_size_for_worker, technical_batch_size, gamma, ps):
        n, K, nc, bw, tb, gamma, p = conf
        if iter_id in do_iters:
            main(n_iters=n,
                 K=K, no_compr=nc, p=p, batch_size_for_worker=bw, gamma=gamma,
